    ...
    <main className="min-h-screen bg-slate-100 px-4 py-8 text-slate-800">
      <div className="mx-auto max-w-4xl rounded-xl bg-white p-6 shadow-sm sm:p-8">
        ...
        <section className="mb-8 leading-7">
          ...
          <p className="mb-2">
            本站为
            <a className="mx-1 text-blue-600 underline" href="https://sooon.ai/" rel="noreferrer" target="_blank">
              素问
            </a>
          ...
          <p className="mb-4">
            项目开源地址：
            <a className="mx-1 text-blue-600 underline" href="https://github.com/wzj042/sooon-about-dev" rel="noreferrer" target="_blank">
          ...
          <p>
            ...
            <a className="mx-1 text-blue-600 underline" href="https://github.com/wzj042/sooon-about-dev/issues" rel="noreferrer" target="_blank">
              Github issue
            </a>
